...
*/}}
{{- define "argocd-resources.issuer" -}}
...
Common labels
*/}}
{{- define "argocd-resources.labels" -}}
helm.sh/chart: {{ include "argocd-resources.chart" . }}
app.kubernetes.io/name: {{ include "argocd-resources.name" . }}
